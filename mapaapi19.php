<?php
  ...
  class mapaapi19 extends Rest {
   ...
   public function procesarLLamada() {
     ...
     call_user_func(array($this,"mapaapi19"));
  ...
  private function mapaapi18($fecha) {
    ...
    //$varr = 'holismapaapi';
    $query = $this->_conn->prepare("select cord1,cord2,ppm,fecha from data2 where fecha between '2017-10-19' and '2017-10-20'");
    $query->execute();

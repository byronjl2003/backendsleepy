       ...
       $query = $this->_conn->prepare(
        "START TRANSACTION;
          ...
          */
          ...
          $query->bindValue(2,$hume, PDO::PDO::PARAM_INT);
          $query->bindValue(3,$mov, PDO::PDO::PARAM_INT);
          $query->bindValue(4,$luz, PDO::PDO::PARAM_INT);
          $query->bindValue(5,$sonido, PDO::PDO::PARAM_INT);
          $query->bindValue(6,$ronq, PDO::PDO::PARAM_INT);
       $query->execute();

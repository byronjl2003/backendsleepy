<?php
  ...
  class GetLastFive extends Rest {
  ...
  private function getlastfive($email) {
    ...
    */
    ...
    $query = $this->_conn->prepare("select D.fecha,D.temperatura,D.humedad,D.movimiento,D.luz,D.sonido,D.ronquido FROM data D ORDER BY D.fecha DESC limit 5");

<?php
  ...
  class GetMovimiento extends Rest {
   ...
   public function procesarLLamada() {
     ...
     call_user_func_array(array($this,"getmovimiento"),$array_);
  ...
  private function getmovimiento($email) {
     ...
     */
     ...
     $query = $this->_conn->prepare("select T.movimiento FROM(select D.fecha,D.movimiento FROM master_det M INNER JOIN data D ON M.id = D.id WHERE M.correo = ?) T ORDER BY T.fecha DESC LIMIT 1;");

<?php
  ...
  class GetRonquido extends Rest {
   ...
   public function procesarLLamada() {
     ...
     call_user_func_array(array($this,"getronquido"),$array_);
  ...
  private function getronquido($email) {
     ...
     */
     ...
     $query = $this->_conn->prepare("select T.ronquido FROM(select D.fecha,D.ronquido FROM master_det M INNER JOIN data D ON M.id = D.id WHERE M.correo = ?) T ORDER BY T.fecha DESC LIMIT 1;");
